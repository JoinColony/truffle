...
var Contracts = {
  ...
  createContractAndWait: function(config, contract_name) {
    var self = this;
    //data should be prefixed with '0x' on Parity
    var contractBinary = config.contracts.classes[contract_name].binary;
    if(contractBinary && !contractBinary.startsWith('0x')) {
